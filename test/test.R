...
sl2_head_sub <- sl2_head[117000:120000,]

plot(sl2_head_sub$lon, sl2_head_sub$lat)
sl2_frame_Primary <- read_sonar_frame(test_sl2, sl2_head_sub, "Primary")
sl2_frame_Secondary <- read_sonar_frame(test_sl2, sl2_head_sub, "Secondary")
